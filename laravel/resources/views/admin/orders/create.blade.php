...
@section('title', 'Tao don hang')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Tao don hang</h4>
    ...
    <div class="row g-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('customer_phone') is-invalid @enderror" name="customer_phone" value="{{ old('customer_phone') }}" required>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('delivery_type') is-invalid @enderror" name="delivery_type" required>
                                ...
                                <option value="delivery" {{ old('delivery_type') == 'delivery' ? 'selected' : '' }}>Giao hang tan noi</option>
                                <option value="pickup" {{ old('delivery_type') == 'pickup' ? 'selected' : '' }}>Nhan tai cua hang</option>
                            </select>
                            @error('delivery_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('delivery_address') is-invalid @enderror" name="delivery_address" value="{{ old('delivery_address') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="time" class="form-control @error('delivery_time') is-invalid @enderror" name="delivery_time" value="{{ old('delivery_time') }}">
                            @error('delivery_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="gift_recipient_name" value="{{ old('gift_recipient_name') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">SDT nguoi nhan qua</label>
                            <input type="text" class="form-control" name="gift_recipient_phone" value="{{ old('gift_recipient_phone') }}">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table align-middle mb-0" id="order-items-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control form-control-sm" name="items[0][unit_price]" value="0"></td>
                                    <td><input type="text" class="form-control form-control-sm bg-light" value="0" readonly></td>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="subtotal" value="{{ old('subtotal', 0) }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Phi giao hang</label>
                        <input type="number" class="form-control @error('shipping_fee') is-invalid @enderror" name="shipping_fee" value="{{ old('shipping_fee', 0) }}">
                        @error('shipping_fee')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount', 0) }}">
                        @error('discount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control fw-bold" name="total" value="{{ old('total', 0) }}" readonly>
                    </div>
                    <div class="mb-0">
                        ...
                        <select class="form-select @error('payment_method') is-invalid @enderror" name="payment_method">
                            <option value="cod" {{ old('payment_method') == 'cod' ? 'selected' : '' }}>Tien mat (COD)</option>
                            <option value="bank_transfer" {{ old('payment_method') == 'bank_transfer' ? 'selected' : '' }}>Chuyen khoan</option>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="status">
                            <option value="pending" {{ old('status') == 'pending' ? 'selected' : '' }}>Cho xac nhan</option>
                            <option value="confirmed" {{ old('status') == 'confirmed' ? 'selected' : '' }}>Da xac nhan</option>
                            <option value="processing" {{ old('status') == 'processing' ? 'selected' : '' }}>Dang lam banh</option>
                        </select>
                    </div>
                    <div class="mb-0">
            ...
            <button type="submit" class="btn btn-primary w-100">
                <i class="bi bi-check-lg"></i> Luu don hang
            </button>
        </div>
    </div>
</form>
