            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('site_name') is-invalid @enderror" id="site_name" name="site_name" value="{{ old('site_name', $settings['site_name'] ?? 'Thu Huong Cake') }}">
                    ...
                    <div class="mb-3">
                        ...
                        @if(isset($settings['logo']) && $settings['logo'])
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $settings['logo']) }}" class="rounded" style="max-height:60px">
                            </div>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('hotline') is-invalid @enderror" id="hotline" name="hotline" value="{{ old('hotline', $settings['hotline'] ?? '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('opening_hours') is-invalid @enderror" id="opening_hours" name="opening_hours" value="{{ old('opening_hours', $settings['opening_hours'] ?? '') }}" placeholder="VD: 7:00 - 22:00">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('default_shipping_fee') is-invalid @enderror" id="default_shipping_fee" name="default_shipping_fee" value="{{ old('default_shipping_fee', $settings['default_shipping_fee'] ?? '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('freeship_distance') is-invalid @enderror" id="freeship_distance" name="freeship_distance" value="{{ old('freeship_distance', $settings['freeship_distance'] ?? '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('freeship_min_order') is-invalid @enderror" id="freeship_min_order" name="freeship_min_order" value="{{ old('freeship_min_order', $settings['freeship_min_order'] ?? '') }}">
                            <span class="input-group-text">&dstrok;</span>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('tiktok_url') is-invalid @enderror" id="tiktok_url" name="tiktok_url" value="{{ old('tiktok_url', $settings['tiktok_url'] ?? '') }}" placeholder="https://tiktok.com/@...">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('address_hanoi') is-invalid @enderror" id="address_hanoi" name="address_hanoi" value="{{ old('address_hanoi', $settings['address_hanoi'] ?? '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('address_hcm') is-invalid @enderror" id="address_hcm" name="address_hcm" value="{{ old('address_hcm', $settings['address_hcm'] ?? '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('business_license') is-invalid @enderror" id="business_license" name="business_license" value="{{ old('business_license', $settings['business_license'] ?? '') }}">
