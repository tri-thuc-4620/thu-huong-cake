    ...
    <div class="card-body">
        <form action="{{ route('admin.hero-slides.update', $slide) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('badge_text') is-invalid @enderror" id="badge_text" name="badge_text" value="{{ old('badge_text', $slide->badge_text) }}" placeholder="VD: Moi, Hot, Sale...">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title_line_1') is-invalid @enderror" id="title_line_1" name="title_line_1" value="{{ old('title_line_1', $slide->title_line_1) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title_line_2') is-invalid @enderror" id="title_line_2" name="title_line_2" value="{{ old('title_line_2', $slide->title_line_2) }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('button_1_text') is-invalid @enderror" id="button_1_text" name="button_1_text" value="{{ old('button_1_text', $slide->button_1_text) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('button_1_url') is-invalid @enderror" id="button_1_url" name="button_1_url" value="{{ old('button_1_url', $slide->button_1_url) }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('button_2_text') is-invalid @enderror" id="button_2_text" name="button_2_text" value="{{ old('button_2_text', $slide->button_2_text) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('button_2_url') is-invalid @enderror" id="button_2_url" name="button_2_url" value="{{ old('button_2_url', $slide->button_2_url) }}">
            ...
            <div class="mb-3">
                ...
                @if($slide->image)
                    <div class="mb-2">
                        <img src="{{ Storage::url($slide->image) }}" class="rounded" style="max-height:120px">
                    </div>
                @endif
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $slide->is_active) ? 'checked' : '' }}>
                        <label class="form-check-label" for="is_active">Hoat dong</label>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="sort_order" class="form-label">Thu tu</label>
                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', $slide->sort_order) }}">
