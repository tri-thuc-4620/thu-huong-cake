...
<head>
    ...
    <title>Dang ky - Thu Huong Cake</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .input-group:focus-within .input-group-text { border-color: #10b981; color: #10b981; }
        .password-toggle {
        ...
        .btn-register:hover { background: #ecfdf5; border-color: #6ee7b7; color: #10b981; }
        .bottom-text { text-align: center; margin-top: 1.5rem; font-size: 0.8rem; color: #94a3b8; }
        .bottom-text a { color: #10b981; text-decoration: none; font-weight: 500; }
...
<body>
    <div class="login-wrapper">
        ...
        <div class="login-card">
            <h2>Dang ky</h2>
            <p class="subtitle">Nhap thong tin de tao tai khoan</p>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               placeholder="Nguyen Van A" value="{{ old('name') }}" required autofocus autocomplete="name">
                    </div>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                               placeholder="email@thuhuongcake.vn" value="{{ old('email') }}" required autocomplete="username">
                    </div>
                    @error('email')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
            ...
            <a href="{{ route('login') }}" class="btn-register">
                <i class="bi bi-box-arrow-in-right"></i> Da co tai khoan? Dang nhap
            </a>
        </div>
